...
describe("CLI", () => {
  ...
  test("convert supports --pi-home for pi output", async () => {
    ...
    expect(await exists(path.join(piRoot, "skills", "compound-engineering", "repo-research-analyst", "SKILL.md"))).toBe(true)
  ...
  test("sync --target all detects new sync targets and ignores stale cursor directories", async () => {
    ...
    expect(await exists(path.join(tempHome, ".codex", "skills", "compound-engineering", "workflows-plan", "SKILL.md"))).toBe(true)
    ...
    expect(await exists(path.join(tempHome, ".kiro", "skills", "compound-engineering", "workflows-plan", "SKILL.md"))).toBe(true)
    ...
    expect(await exists(path.join(tempHome, ".copilot", "skills", "compound-engineering", "workflows-plan", "SKILL.md"))).toBe(true)
    ...
    expect(await exists(path.join(tempHome, ".openclaw", "skills", "compound-engineering", "skill-one"))).toBe(true)
  })
})
